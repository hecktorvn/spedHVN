...
use DOMDocument;
use NFePHP\CTe\Common\InvalidArgumentException;
use NFePHP\CTe\Common\RuntimeException;
...
class Tools
{
    ...
    public function __construct($configJson, Certificate $certificate)
    {
        ...
        $this->aConfig = (array) $this->config;
    ...
    protected function servico(
        ...
        try{
            ...
            $stdServ = $webs->get('RS', $ambiente, $this->modelo);
        }
    ...
    protected function getXmlUrlPath()
    {
        ...
        if (!file_exists($file)) {
            throw new \InvalidArgumentException('Arquivo de WebService não encontrado! - ' . $file);
        }
